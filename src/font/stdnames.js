// Static glyph-name tables the font formats refer to by index, kept out of
// parse.js because they are pure data. Generated from fontTools
// (standardGlyphOrder, cffStandardStrings) — both lists are frozen by their
// specs and never change.

// post format 2.0: glyph name indices below 258 name a glyph from this list.
export const MAC_GLYPH_NAMES = `
...
// CFF: SIDs below 391 name a glyph from this list, the rest index the
// font's own String INDEX.
export const CFF_STANDARD_STRINGS = `
  ...
  b c d e f g h i j k l m n o p q r s t u v w x y z braceleft bar braceright
